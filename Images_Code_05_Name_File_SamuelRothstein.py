...
cv2.createTrackbar('GS0_position','Grayscale Sliders', 127, 255, lambda x:None)
cv2.createTrackbar('GS1_position','Grayscale Sliders', 127, 255, lambda x:None)
cv2.createTrackbar('GS2_position','Grayscale Sliders', 127, 255, lambda x:None)
cv2.createTrackbar('GS3_position','Grayscale Sliders', 127, 255, lambda x:None)
cv2.createTrackbar('GS4_position','Grayscale Sliders', 127, 255, lambda x:None)
...
#Color 1
cv2.createTrackbar('color1_R','Color 1 Components', 127, 255, lambda x:None)
cv2.createTrackbar('color1_G','Color 1 Components', 127, 255, lambda x:None)
cv2.createTrackbar('color1_B','Color 1 Components', 127, 255, lambda x:None)
#Color 2
cv2.createTrackbar('color2_R','Color 2 Components', 127, 255, lambda x:None)
cv2.createTrackbar('color2_G','Color 2 Components', 127, 255, lambda x:None)
cv2.createTrackbar('color2_B','Color 2 Components', 127, 255, lambda x:None)
#Color 3
cv2.createTrackbar('color3_R','Color 3 Components', 127, 255, lambda x:None)
cv2.createTrackbar('color3_G','Color 3 Components', 127, 255, lambda x:None)
cv2.createTrackbar('color3_B','Color 3 Components', 127, 255, lambda x:None)
#Color 4
cv2.createTrackbar('color4_R','Color 4 Components', 127, 255, lambda x:None)
cv2.createTrackbar('color4_G','Color 4 Components', 127, 255, lambda x:None)
cv2.createTrackbar('color4_B','Color 4 Components', 127, 255, lambda x:None)
#Color 5
cv2.createTrackbar('color5_R','Color 5 Components', 127, 255, lambda x:None)
cv2.createTrackbar('color5_G','Color 5 Components', 127, 255, lambda x:None)
cv2.createTrackbar('color5_B','Color 5 Components', 127, 255, lambda x:None)
