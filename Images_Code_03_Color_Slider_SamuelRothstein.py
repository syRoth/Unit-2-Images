...
#Color each paper
color0_paper[0:img_height, 0:img_width, 0:img_channels] = [88,46,201]
color1_paper[0:img_height, 0:img_width, 0:img_channels] = [63,189,60]

#Create trackbars for grayscale breaks
cv2.createTrackbar('GS0_position','Grayscale Sliders', 107, 255, lambda x:None)
cv2.createTrackbar('GS1_position','Grayscale Sliders', 147, 255, lambda x:None)
...
while (keypressed != 27 and keypressed != ord('s')):
    ...
    color2_paper[0:img_height, 0:img_width, 0:img_channels] = [color0_B,color0_G,color0_R]
    ...
    custom_img = cv2.bitwise_or(cv2.bitwise_or(color0_part, color1_part), color2_part)
    ...
    cv2.imshow('Color 2 Parts of Image',color2_part)
